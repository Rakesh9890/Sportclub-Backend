        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtImageurl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StadiumsStadiumId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sports", x => x.SportId);
                    table.ForeignKey(
                        name: "FK_Sports_Stadiums_StadiumsStadiumId",
                        column: x => x.StadiumsStadiumId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourtPrice = table.Column<double>(type: "float", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courts_Sports_SportsSportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courts_SportsSportId",
                table: "Courts",
                column: "SportsSportId");

            migrationBuilder.CreateIndex(
                name: "IX_Sports_StadiumsStadiumId",
                table: "Sports",
                column: "StadiumsStadiumId");
        }
